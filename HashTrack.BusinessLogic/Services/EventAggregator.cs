...
namespace HashTrack.BusinessLogic.Services
{
    ...
    public class EventAggregator : IEventAggregator
    {
                ...
                Func<object, Task> asyncHandlersWithData = null)
            {
                ...
                if (handlers != null)
                {
                    eventHandlers.Handlers.Remove(handlers);
                }
                if (asyncHandlers != null)
                {
                    eventHandlers.AsyncHandlers.Remove(asyncHandlers);
                }
                if (handlersWithData != null)
                {
                    eventHandlers.HandlersWithData.Remove(handlersWithData);
                }
                if (asyncHandlersWithData != null)
                {
                    eventHandlers.AsyncHandlersWithData.Remove(asyncHandlersWithData);
                }
                ...
                Func<object, Task> asyncHandlersWithData = null)
            {
                ...
                if (handlers != null)
                {
                    eventHandlers.Handlers.Add(handlers);
                }
                if (asyncHandlers != null)
                {
                    eventHandlers.AsyncHandlers.Add(asyncHandlers);
                }
                if (handlersWithData != null)
                {
                    eventHandlers.HandlersWithData.Add(handlersWithData);
                }
                if (asyncHandlersWithData != null)
                {
                    eventHandlers.AsyncHandlersWithData.Add(asyncHandlersWithData);
                }
            }
            ...
            private EventHandlers GetHandlersForKey(string eventTag)
            {
                ...
                {
                    _eventHandlers[eventTag] = new EventHandlers();
                }
            ...
            private class EventHandlers
            {
                ...
                public List<Func<Task>> AsyncHandlers { get; set; }
                public List<Action<object>> HandlersWithData { get; set; }
                public List<Func<object, Task>> AsyncHandlersWithData { get; set; }
